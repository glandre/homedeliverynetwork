...
@section('settings-menu')
    <div class="dropdown-menu">
        <a class="dropdown-item" href="{{ url('/vendors/create') }}">Create a New Vendor</a>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card-box table-responsive">
                <h4 class="m-t-0 header-title"><b>Managing vendors:</b></h4>
                <p class="text-muted font-13 m-b-30">
                    These are the vendors used to classify products.
                    Click on a vendor name to view its description and edit it.
                </p>
