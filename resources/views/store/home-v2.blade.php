<!DOCTYPE html>
<!-- saved from url=(0043){{url('/store/home-v2')}} -->
<html lang="en" class=" js canvas no-touch rgba multiplebgs backgroundsize borderimage borderradius boxshadow textshadow opacity cssanimations cssgradients csstransforms csstransforms3d csstransitions fontface generatedcontent video audio svg svgclippaths"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
...
<body class="page-preloading hasScrollbar loading-done">
  ...
  <div class="page-wrapper">
    ...
    <header class="navbar navbar-sticky">
      ...
      <div class="lang-switcher">
        <div class="lang-toggle">
          ...
          <ul class="lang-dropdown">
            <li><a href="{{url('/store/home-v2')}}#"><img src="/images/store/FR.png" alt="French">FR</a></li>
            <li><a href="{{url('/store/home-v2')}}#"><img src="/images/store/DE.png" alt="German">DE</a></li>
            <li><a href="{{url('/store/home-v2')}}#"><img src="/images/store/IT.png" alt="Italian">IT</a></li>
          </ul>
        </div>
      </div><!-- .lang-switcher -->
      ...
      <div class="toolbar">
        <div class="inner">
          <a href="{{url('/store')}}#menu" class="toolbar-toggle"><i class="material-icons menu"></i></a>
          <a href="{{url('/store')}}#account" class="toolbar-toggle"><i class="material-icons person"></i></a>
          <a href="{{url('/store')}}#cart" class="toolbar-toggle">
            <i>
      ...
      <div class="toolbar-dropdown">
          ...
          <div class="inner">
            <ul class="main-navigation space-bottom">
              <li class="menu-item-has-children current-menu-item">
                <a href="{{url('/store/home-v2')}}#">Home</a>
                <ul class="sub-menu">
                  <li><a href="{{url('/store')}}">Home Version 1</a></li>
                  <li class="current-menu-item"><a href="{{url('/store/home-v2')}}">Home Version 2</a></li>
                  <li><a href="{{url('/store/home-v2')}}">Home Version 3</a></li>
                </ul>
              </li>
              <li class="menu-item-has-children">
                <a href="{{url('/store/home-v2')}}#">Shop</a>
                <ul class="sub-menu">
            ...
            <ul class="list-icon text-sm">
              ...
              <li>
                ...
                <a href="{{url('/store/home-v2')}}#">skype_id</a>
              </li>
            </ul><!-- .list-icon -->
            <span class="text-sm display-inline" style="margin-bottom: 6px;">Social accounts: &nbsp;&nbsp;</span>
            <div class="social-bar display-inline">
              <a href="{{url('/store/home-v2')}}#" class="sb-facebook" data-toggle="tooltip" data-placement="top" title="" data-original-title="Facebook">
                <i class="socicon-facebook"></i>
              </a>
              <a href="{{url('/store/home-v2')}}#" class="sb-google-plus" data-toggle="tooltip" data-placement="top" title="" data-original-title="Google+">
                <i class="socicon-googleplus"></i>
              </a>
              <a href="{{url('/store/home-v2')}}#" class="sb-twitter" data-toggle="tooltip" data-placement="top" title="" data-original-title="Twitter">
                <i class="socicon-twitter"></i>
              </a>
              <a href="{{url('/store/home-v2')}}#" class="sb-instagram" data-toggle="tooltip" data-placement="top" title="" data-original-title="Instagram">
        ...
        <div class="toolbar-section" id="account">
          ...
          <div class="inner">
              ...
              <div class="form-footer">
                <div class="rememberme">
                  <label class="checkbox">
                    <div class="icheckbox checked"><input type="checkbox" checked="" style="position: absolute; opacity: 0;"><ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; border: 0px; opacity: 0; background: rgb(255, 255, 255);"></ins></div> Remember me
                  </label>
                </div>
            ...
            <p class="text-sm space-top">Don’t have an account? <a href="{{url('/store/home-v2')}}#signup" class="toggle-section">Signup here</a> or with social account:</p>
            <a href="{{url('/store/home-v2')}}#" class="social-signup-btn ssb-facebook">
              <i class="socicon-facebook"></i>
              <span>Signup with Facebook</span>
            </a>
            <a href="{{url('/store/home-v2')}}#" class="social-signup-btn ssb-google">
              <i class="socicon-googleplus"></i>
              <span>Signup with Google+</span>
            </a>
            <a href="{{url('/store/home-v2')}}#" class="social-signup-btn ssb-twitter">
              <i class="socicon-twitter"></i>
        ...
        <div class="toolbar-section" id="signup">
          ...
          <div class="inner">
            ...
            <p class="text-sm space-top">Already have an account? Than <a href="{{url('/store/home-v2')}}#account" class="toggle-section">Login here</a></p>
          </div><!-- .inner -->
        </div><!-- .toolbar-section#account -->
        ...
        <div class="toolbar-section" id="cart">
          <div class="shopping-cart">
            ...
            <div class="item">
              ...
              <div class="item-details">
                ...
                <div class="count-input">
                  <a class="incr-btn" data-action="decrease" href="{{url('/store/home-v2')}}#">–</a>
                  <input class="quantity" type="text" value="1">
                  <a class="incr-btn" data-action="increase" href="{{url('/store/home-v2')}}#">+</a>
                </div>
              </div>
              <a href="{{url('/store/home-v2')}}#" class="item-remove" data-toggle="tooltip" data-placement="top" title="" data-original-title="Remove">
            ...
            <div class="text-right">
              <a href="{{url('/store/home-v2')}}#" class="btn btn-default btn-ghost close-dropdown">Continue Shopping</a>
              <a href="{{url('/store/home-v2')}}#checkout" class="btn btn-primary waves-effect waves-light toggle-section">Proceed to Checkout</a>
            </div>
          </div><!-- .shopping-cart -->
        ...
        <div class="toolbar-section" id="checkout">
          <form method="post" class="checkout-form container">
            <div class="cart-subtotal space-bottom">
              ...
              <div class="column">
                <h3 class="amount"><small class="hidden-xs">3 items&nbsp;&nbsp;&nbsp;</small>$161.90</h3>
              </div>
            </div><!-- .subtotal -->
            <div class="row">
              <div class="col-sm-6">
            ...
            <div class="form-group">
              <label class="radio radio-inline">
                <div class="iradio checked"><input type="radio" name="co_shipping" checked="" style="position: absolute; opacity: 0;"><ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; border: 0px; opacity: 0; background: rgb(255, 255, 255);"></ins></div> Ship to this address
              </label>
              <label class="radio radio-inline">
                <div class="iradio"><input type="radio" name="co_shipping" style="position: absolute; opacity: 0;"><ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; border: 0px; opacity: 0; background: rgb(255, 255, 255);"></ins></div> Ship to different address
              </label>
            </div><!-- .form-group -->
            <div class="text-right">
              <a href="{{url('/store/home-v2')}}#cart" class="btn btn-default btn-ghost icon-left toggle-section">
    ...
    <section class="container-fluid" style="padding-top: 30px;">
      <div class="row">
        <div class="col-md-6">
          <a href="{{url('/store/home-v2')}}#" class="category-tile">
            <div class="inner">
              <div class="column">
              ...
              <div class="column">
                <div class="category-thumb">
                  <img src="/images/store/tile01.jpg" alt="Category">
                </div>
              </div>
            </div>
          </a>
        ...
        <div class="col-md-6">
          <a href="{{url('/store/home-v2')}}#" class="category-tile">
            <div class="inner">
              ...
              <div class="column">
                <div class="category-thumb">
                  <img src="/images/store/tile02.jpg" alt="Category">
                </div>
              </div>
            </div>
          </a>
        ...
        <div class="col-md-6">
          <a href="{{url('/store/home-v2')}}#" class="category-tile">
            <div class="inner">
              ...
              <div class="column">
                <div class="category-thumb">
                  <img src="/images/store/tile03.jpg" alt="Category">
                </div>
              </div>
            </div>
          </a>
        ...
        <div class="col-md-6">
          <a href="{{url('/store/home-v2')}}#" class="category-tile">
            <div class="inner">
              ...
              <div class="column">
                <div class="category-thumb">
                  <img src="/images/store/tile04.jpg" alt="Category">
                </div>
              </div>
            </div>
          </a>
          ...
          <div class="shop-item">
            <div class="shop-thumbnail">
              ...
              <div class="shop-item-tools">
                <a href="{{url('/store/home-v2')}}#" class="add-to-whishlist" data-toggle="tooltip" data-placement="top" title="" data-original-title="Wishlist">
                  <i class="material-icons favorite_border"></i>
                </a>
                <a href="{{url('/store/home-v2')}}#" class="add-to-cart">
                  <em>Add to Cart</em>
      ...
      <div class="container">
        ...
        <div class="info-box text-center">
          ...
          <a href="shop-single.html" class="inline">
            <img src="/images/store/special-offer2.jpg" alt="Special Offer">
          </a>
      ...
      <div class="row padding-top">
        <div class="col-lg-3 col-sm-6">
          <div class="shop-item">
            <div class="shop-thumbnail">
              ...
              <a href="{{url('/store/home-v2')}}#" class="item-link"></a>
            ...
            <div class="shop-item-details">
              <h3 class="shop-item-title"><a href="{{url('/store/home-v2')}}#">Wall Clock</a></h3>
              <span class="shop-item-price">
        ...
        <div class="col-lg-3 col-sm-6">
          <div class="shop-item">
            ...
            <div class="shop-item-details">
              <h3 class="shop-item-title"><a href="{{url('/store/home-v2')}}#">LED Lighting</a></h3>
              <span class="shop-item-price">
                $130.00
              </span>
            </div>
        ...
        <div class="col-lg-3 col-sm-6">
          <div class="shop-item">
            ...
            <div class="shop-item-details">
              <h3 class="shop-item-title"><a href="{{url('/store/home-v2')}}#">Alarm Clock</a></h3>
              <span class="shop-item-price">
                $178.00
              </span>
            </div>
        ...
        <div class="col-lg-3 col-sm-6">
          <div class="shop-item">
            ...
            <div class="shop-item-details">
              <h3 class="shop-item-title"><a href="{{url('/store/home-v2')}}#">Hook Basket</a></h3>
              <span class="shop-item-price">
                $112.35
              </span>
            </div>
    ...
    <section class="container padding-top-2x padding-bottom">
      ...
      <div class="row padding-top">
        ...
        <div class="col-sm-4 col-xs-6">
          <a href="{{url('/store/home-v2')}}#" class="brand">
    ...
    <footer class="footer">
      <div class="column">
        ...
        <div class="social-bar text-center space-bottom">
          <a href="{{url('/store/home-v2')}}#" class="sb-skype" data-toggle="tooltip" data-placement="top" title="" data-original-title="Skype">
            <i class="socicon-skype"></i>
          </a>
          <a href="{{url('/store/home-v2')}}#" class="sb-facebook" data-toggle="tooltip" data-placement="top" title="" data-original-title="Facebook">
            <i class="socicon-facebook"></i>
